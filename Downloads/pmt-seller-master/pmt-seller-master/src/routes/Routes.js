...
import NotFound from "../components/Buyerdashboard/NotFound";
import Forgetemailpass from "../components/Login/Forgetemailpass";
  ...
  return (
    <Routes>
      <Route path="/" element={<MainLayout />}>
        ...
        <Route path="/login-team" element={<NotFound />} />
      ...
      <Route path="/forget" element={<Forgetemailpass />}></Route>
