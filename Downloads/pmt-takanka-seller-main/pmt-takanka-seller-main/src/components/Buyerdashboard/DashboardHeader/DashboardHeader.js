...
const DashboardHeader = () => {
  ...
  return (
    <div className="bg-[#fff] flex items-center justify-between w-full border-b-2 border-[#0674BB]  py-4 z-0">
      <div className="block lg:hidden px-5 ">
        <FaBars onClick={showSidebar} size={25} />
      </div>


      <div className="flex  flex-row w-full justify-between  items-center gap-5  sm:px-5 px-0">
        <div className="">
        ...
        <div className="flex items-center">
          <button className="bg-gray-100 py-2 px-4 rounded font-bold cursor-pointer md:block hidden" onClick={() => redirectToBuyer()}>Switch To Buyer</button>
          <Menu as="div" className="relative inline-block text-left">
            ...
            >
              <Menu.Items className="absolute right-0 z-10 mt-2 w-[12rem] origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                <div className="py-1 px-5">
                  <div className="md:hidden block">
                    <Menu.Item>
                      {({ active }) => (
                        <div className="flex items-center gap-2 w-full cursor-pointer pt-4" onClick={() => redirectToBuyer()}>
                          <AiOutlineUserSwitch size={20} className="text-[#0674BB] font-bold" />
                  ...
                  <Menu.Item>
                    {({ active }) => (
                      <div className="flex items-center justify-left w-full gap-2 cursor-pointer pt-4"  onClick={() => navigate("/profile")}>
                        <CgProfile size={20} className="text-[#0674BB] font-bold" />
                        <span className="font-semibold text-black text-[14px] capitalize">
                          Profile Settings
                        </span>
                    ...
                    <Menu.Item>
                      {({ active }) => (
                        <div className="flex items-center gap-2 w-full cursor-pointer py-4">
                          <BsBoxArrowRight size={20} className="text-[#0674BB] font-bold" />
                          <span className="font-semibold text-black text-[14px] capitalize">
                            Logout
                          </span>
                        </div>
